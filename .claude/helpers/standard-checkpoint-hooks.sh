...
EOF
        ...
        echo "PASS Created checkpoint: $checkpoint_branch for $file"
    fi
}
...
EOF
                ...
                echo "PASS Created checkpoint: $tag_name for $file"
            else
...
EOF
        ...
        echo "PASS Created task checkpoint: $checkpoint_name"
    fi
}
...
EOF
    ...
    echo "PASS Session summary saved to: $summary_file"
