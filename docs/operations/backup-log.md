...
| 2025-02-02 | rds:community-content-hub-prod-2025-02-02-07-45 | Snapshot restored and queried via RDS Data API; audit log sample validated, consent table counts aligned with CloudWatch dashboards. Static asset manifest restored from S3 backup. | us-east-1d (temporary) | L. Chen |
