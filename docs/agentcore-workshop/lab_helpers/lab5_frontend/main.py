...
if prompt := st.chat_input("What is up?"):
    ...
    with st.chat_message("assistant"):
        ...
        try:
            ...
            message_placeholder.markdown(f'<span class="thinking-bubble">[ROBOT FACE] [THOUGHT BALLOON] Customer Support Agent is thinking...</span>', unsafe_allow_html=True)
                ...
                if chunk.strip():  # Only process non-empty chunks
                    ...
                    if '"End agent execution"' in accumulated_response:
                        ...
                        message_placeholder.markdown(
                            f'<span class="thinking-bubble">[ROBOT FACE] [ANTICLOCKWISE DOWNWARDS AND UPWARDS OPEN CIRCLE ARROWS] Processing response...</span>', 
            ...
            message_placeholder.markdown(f'<div class="assistant-bubble">[ROBOT FACE] [CROSS MARK] {error_msg}</div>', unsafe_allow_html=True)
            answer = error_msg
            elapsed = time.time() - start_time
