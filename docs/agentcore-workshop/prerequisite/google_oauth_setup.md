# [CLOSED LOCK WITH KEY] Setting Up Google OAuth2 Credentials for Your Agent
...
## [WHITE HEAVY CHECK MARK] 1. Create a Project in Google Developer Console
...
## [PACKAGE] 2. Enable Google Calendar API
...
## [SHIELD] 3. Configure OAuth Consent Screen
...
## [WRENCH] 4. Create OAuth 2.0 Credentials
...
## [KEY] 5. Obtain Client ID and Client Secret
...
## [LEFT-POINTING MAGNIFYING GLASS] 6. Update the Data Access Scopes
